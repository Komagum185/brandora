...
export default function Example() {
  return (
      ...
      <main className="grid grid-rows-[auto,1fr,auto] min-h-screen place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <FaHome color={'white'} size={20} className='flex justify-between'/>
              </Link>
